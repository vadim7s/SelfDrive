'''
this is starting point copied from RL folder carenv_route_steer.py
...
class CarEnv(gym.Env):
	...
	def step(self, action):
		...
		if self.episode_start + SECONDS_PER_EPISODE < time.time():
			...
			self.cleanup()
		return  {'image': self.front_camera/255.0, 'angle': angle}, reward, done, False
	...
	def reset(self,seed):
		...
		return  {'image': (self.front_camera/255.0), 'angle': angle}
