...
1. Using semantic camera - done
2. Tesla aligned images - done
3. Steering - continous
4. Acceleration - smooth continous
5. Navigation - define a goal to travel a short distance
6.
