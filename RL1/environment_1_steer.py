...
this is step 1 where we kept all code from RL but 
expanded action space for throttle and braking 
but in this we just learn steer - braking and throttle dimansions are ignored

Outcome: steering was learning well but the model was
saved with only one dimension of action space MultiDiscrete([9]) 
