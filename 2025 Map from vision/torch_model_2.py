'''
continue from torch_model.py

create stretching of maps to image size as part of processing 

Result was not very impressive afer 10 epochs

Possible reasons:
1 - maps are not a very precise
2 - may need much more images especially away from simple straight roads

Direction from here: try RGB to semantic, but in pytorch this time
...
def save_predicted_image(tensor_in,tensor_out, epoch,batch, output_dir='C://SelfDrive//2025 Map from vision//prediction_eg'):
...
target_dir = 'C://SelfDrive//2025 Map from vision//map_img'
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), f'C://SelfDrive//2025 Map from vision//unet_model_20250219_{epoch}.pth')