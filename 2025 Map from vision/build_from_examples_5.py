...
'''
now we need to start triggering car removals when our car gets stuck
Achieved: when the car stays at same location for 
longer than MAX_WAIT_TIME_SAME_LOCATION constant,
all traffic is removed and re-generated 
