...
# continue form map_grab_continue.py

#loop throught all towns
# different weather
# traffic 
...
DEBUG_FOLDER = 'C:/SelfDrive/2025 Map from vision/debug/'

# list of towns
towns = ['Town01','Town02','Town03','Town04','Town05','Town10HD']

# images per town
TOWN_IMAGE_LIMIT = 100
    ...
    def parse_events(self, client, world, clock, sync_mode):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                return True
            elif world.hud.image_counter >= TOWN_IMAGE_LIMIT:
                return True
    ...
    for town in towns:
        try:
            ...
            if args.autopilot and not sim_world.get_settings().synchronous_mode:
                print("WARNING: You are currently in asynchronous mode and could "
                    "experience some issues with the traffic simulation")
            print('args.autopilot at load',args.autopilot, 'sim_world.get_settings().synchronous_mode',sim_world.get_settings().synchronous_mode)
            print('all settings after load',sim_world.get_settings())
            ...
            display.fill((0,0,0))
            pygame.display.flip()
            print('got to hud and world setting')
            ...
            traffic_manager = client.get_trafficmanager()
            traffic_manager.set_synchronous_mode(True)
            args.sync = True #force consistency

            print('got to before tick')
            sim_world.tick()
            print('got to after first tick')
